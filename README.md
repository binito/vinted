...
Monitor de anúncios Vinted para Raspberry Pi. Pesquisa alvos configuráveis, filtra resultados, envia alertas para ntfy e disponibiliza um painel local para gerir preços e pesquisas pelo telemóvel.
...
- Painel web móvel para consultar, editar o teto de preço ou eliminar buscas.
...
Altere `CONFIG_VIEW_URL` em `vinted_monitor.py` se o IP do Raspberry mudar. O painel permite ajustar o teto ou eliminar uma busca; a alteração é lida pelo monitor na ronda seguinte.
